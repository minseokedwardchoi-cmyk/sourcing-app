 ...
 * world-atlas(countries-50m) topojson의 properties.name 값과 매칭하기 위한 테이블.
 * DB의 country 값은 한글 국가명(예: "미국")이므로, 지도 위 영문 국가명을 거쳐
 * 역매핑하여 DB 보유 여부를 판단하고 상세 페이지로 이동한다.
 *
 * 여기 적힌 영문명은 반드시 world-atlas topojson의 properties.name과 "정확히" 같아야
 * 매칭된다 (예: "South Sudan"이 아니라 "S. Sudan", "Ivory Coast"가 아니라
 * "Côte d'Ivoire"). 국가를 추가/수정할 땐 topojson의 실제 이름을 먼저 확인할 것.
 */
export const KOREAN_TO_ENGLISH = {
  ...
  "중국": "China", "일본": "Japan", "대만": "Taiwan", "홍콩": "Hong Kong", "마카오": "Macao",
  ...
  "네팔": "Nepal", "부탄": "Bhutan", "아프가니스탄": "Afghanistan", "몰디브": "Maldives",
  ...
  "보스니아헤르체고비나": "Bosnia and Herz.", "알바니아": "Albania", "몬테네그로": "Montenegro",
  "북마케도니아": "Macedonia", "몰도바": "Moldova", "몰타": "Malta", "룩셈부르크": "Luxembourg",
  "모나코": "Monaco", "산마리노": "San Marino", "리히텐슈타인": "Liechtenstein",
  "키프로스": "Cyprus", "조지아": "Georgia", "아르메니아": "Armenia", "아제르바이잔": "Azerbaijan",
  "호주": "Australia", "뉴질랜드": "New Zealand", "피지": "Fiji", "파푸아뉴기니": "Papua New Guinea",
  "사모아": "Samoa", "바누아투": "Vanuatu", "키리바시": "Kiribati", "솔로몬 제도": "Solomon Is.",
  "뉴칼레도니아": "New Caledonia", "프랑스령 폴리네시아": "Fr. Polynesia", "쿡 제도": "Cook Is.",
  ...
  "남아프리카": "South Africa", "남아프리카공화국": "South Africa", "남아프리카 공화국": "South Africa",
  "이집트": "Egypt",
  "나이지리아": "Nigeria", "케냐": "Kenya", "에티오피아": "Ethiopia", "탄자니아": "Tanzania",
  "모로코": "Morocco", "알제리": "Algeria", "튀니지": "Tunisia", "리비아": "Libya",
  "가나": "Ghana", "코트디부아르": "Côte d'Ivoire", "세네갈": "Senegal", "카메룬": "Cameroon",
  "우간다": "Uganda", "짐바브웨": "Zimbabwe", "잠비아": "Zambia", "모잠비크": "Mozambique",
  "나미비아": "Namibia", "보츠와나": "Botswana", "마다가스카르": "Madagascar",
  "수단": "Sudan", "남수단": "S. Sudan",
  "콩고민주공화국": "Dem. Rep. Congo", "콩고 민주 공화국": "Dem. Rep. Congo",
  "콩고": "Congo", "콩고 공화국": "Congo",
  "앙골라": "Angola", "말리": "Mali", "니제르": "Niger", "차드": "Chad",
  "기니": "Guinea", "기니비사우": "Guinea-Bissau", "토고": "Togo", "감비아": "Gambia",
  "르완다": "Rwanda", "부룬디": "Burundi", "말라위": "Malawi", "모리셔스": "Mauritius",
  "모리타니": "Mauritania", "세이셸": "Seychelles", "시에라리온": "Sierra Leone",
  "소말리아": "Somalia", "부르키나 파소": "Burkina Faso",
  ...
  "쿠바": "Cuba", "자메이카": "Jamaica", "아이티": "Haiti", "바베이도스": "Barbados",
  "도미니카공화국": "Dominican Rep.", "도미니카 공화국": "Dominican Rep.", "도미니카 연방": "Dominica",
  "트리니다드 토바고": "Trinidad and Tobago", "포클랜드 제도": "Falkland Is.",
  "파나마": "Panama", "코스타리카": "Costa Rica", "과테말라": "Guatemala", "온두라스": "Honduras",
  "엘살바도르": "El Salvador", "니카라과": "Nicaragua", "벨리즈": "Belize",
  "그린란드": "Greenland", "동티모르": "Timor-Leste", "푸에르토리코": "Puerto Rico",
};
