...
- 미국: Walmart, Costco, Kroger, Target, Sam's Club, Trader Joe's, Whole Foods, Albertsons/Safeway, Publix
- 유럽: Carrefour, Tesco, Aldi, Lidl, Metro, Auchan, Rewe, Ahold Delhaize
- 일본: AEON(이온), Seven & i Holdings(세븐일레븐/이토요카도), Life Corporation(라이프), Don Quijote/PPIH(돈키호테)
- 중국: Alibaba/Tmall, JD.com(京东), Hema(盒马), Costco China, Yonghui(永辉), Aldi China, Walmart China/Sam's Club China, RT-Mart(大润发)
"""
